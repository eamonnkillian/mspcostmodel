...
class Marketing_Model extends Model {

    function __construct() {
        parent::__construct();
    }
    
    public function ajax_marketingShowColumnEntries($arg) {
        $tableName = $arg;
    ...
    public function ajax_marketingShowColumns($arg) {
        $tableName = $arg;
    ...
    public function ajax_marketingModify() {
