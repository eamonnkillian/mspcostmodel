...
class Enduser_Model extends Model {

    function __construct() {
        parent::__construct();
    }

    public function ajax_enduserShow() {
    ...
    public function ajax_enduserAdd() {
        $tableName = $_POST['tableName'];
    ...
    public function ajax_enduserDelete() {
        $id = $_POST['id'];
        $tableName = $_POST['tableName'];
    ...
    public function ajax_enduserModify() {
        $tableName=$_POST['tableName'];
