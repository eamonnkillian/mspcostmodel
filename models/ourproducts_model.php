...
class Ourproducts_Model extends Model {

    function __construct() {
        parent::__construct();
    }

    public function ajax_ourproductsShow() {
    ...
    public function ajax_ourproductsAdd() {
        $tableName = $_POST['tableName'];
    ...
    public function ajax_ourproductsDelete() {
        $id = $_POST['id'];
        $tableName = $_POST['tableName'];
    ...
    public function ajax_ourproductsModify() {
        $tableName=$_POST['tableName'];
    ...
    public function ajax_getInternalorExternal() {
        $tableName = $_GET['tableName'];
        $statement = $this->database->prepare("SELECT internal_or_external FROM internal_or_external;");
        $statement->setFetchMode(PDO::FETCH_ASSOC);
        $statement->execute();
        $data = $statement->fetchAll();
        $newarr1=array();
